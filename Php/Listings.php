                ...
                <div class="recent-post">
                  ...
                  <div class="recent-single-post">
                    ...
                    <div class="pst-content">
                      <p><form method="POST" action="Listings.php">
				  <button type="submit" class="ready-btn page-scroll" name="go_btn" value="Go">Mike's Breakfast</button>
				  </form></a></p>
                    </div>
                  </div>
                  <!-- End single post -->
                  ...
                  <div class="recent-single-post">
                    ...
                    <div class="pst-content">
                      <p><a href="#"> Tina's Fast Foods</a></p>
                    </div>
                  </div>
                  <!-- End single post -->
                  <!-- start single post -->
                  ...
                  <div class="recent-single-post">
                    <div class="post-img">
                      <a href="#">
												   <img src="img/Listing/4.jpg" alt="">
												</a>
                    </div>
                    <div class="pst-content">
                      <p><a href="#"> Your Healthy Breakfast</a></p>
                    </div>
                  </div>
                  <!-- End single post -->
				    </div>
                      ...
                      <p><a href="#"> 
						<table align="center" border="1px" style="width:1000px; line-height: 70px;">
							...
							<tr>
								...
								<th><center>Store Hours</center> </th>
								<th><center>Store Location</center></th>
